...
import { Archive, ArrowDownToLine, Brush, ChevronRight, CircleHelp, Eraser, FilePlus2, FolderOpen, Grid2X2, ImagePlus, Layers3, Loader2, LogOut, MoreHorizontal, MousePointer2, Palette, PanelLeftClose, Plus, RotateCcw, Sparkles, Trash2, Upload, WandSparkles } from "lucide-react";
...
export default function Home() {
  ...
  return <div className="studio-shell">
    <aside className="studio-sidebar">
      ...
      <div className="sidebar-bottom"><button className="side-nav-item"><CircleHelp size={18}/><span>Help center</span></button><button className="side-nav-item" onClick={logout}><LogOut size={18}/><span>Sign out</span></button></div>
    </aside>
    ...
    <main className="studio-main">
      ...
      <section className="editor-workspace">
        <div className="canvas-column">
          <div className="canvas-frame"><div className="canvas-ruler top-ruler"/><div className="canvas-ruler side-ruler"/><WorksheetCanvas state={canvas} onChange={setCanvas} selectedId={selectedId} onSelect={setSelectedId} tool={tool} brushColor={brushColor} brushSize={brushSize}/></div>
